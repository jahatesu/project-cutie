...
document.addEventListener('DOMContentLoaded', () => {
    fetch("./vinyl.svg")
      ...
      .then((svg) => {
        ...
        / Make container bigger and center it
      playerContainer.style.width = "500px";   // container size
      ...
      const vinyl = playerContainer.querySelector("svg");

        playerContainer.innerHTML = svg;

        const vinyl = document.querySelector("svg");
        // Make the vinyl bigger
      vinyl.style.width = "400px";   // adjust size as needed
      vinyl.style.height = "400px";
      vinyl.style.display = "block";
      vinyl.style.margin = "0 auto"; // center horizontally
