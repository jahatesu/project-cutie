...
// Create stars
        ...
        function animateAirplane() {
            ...
            // Flight path coordinates (Philippines to Canada)
            const startX = 80; // Philippines position (%)
            const startY = 40;
            const endX = 20;   // Canada position (%)
            const endY = 30;
            ...
            function updatePosition() {
                ...
                // Bezier curve calculation for curved path
                const t = progress;
                const controlX = 50; // Middle point for curve
                const controlY = 15; // Higher point for arc

                // Quadratic Bezier curve formula
                const x = (1 - t) * (1 - t) * startX + 2 * (1 - t) * t * controlX + t * t * endX;
                const y = (1 - t) * (1 - t) * startY + 2 * (1 - t) * t * controlY + t * t * endY;

                airplane.style.left = x + '%';
