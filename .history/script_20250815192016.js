...
// -------- PIN VALIDATION --------
const correctPin = "7465"; //ASCII for JA
...
function checkPin() {
  ...
  if (enteredPin === correctPin) {
    resultText.textContent = "Correct PIN! Welcome!";
    resultText.style.color = "#a7c957";
    // Switch to next card
    card1.style.display = "none";
    card2.style.display = "block";
  } else {
    resultText.textContent = "Incorrect PIN. Try again!";
